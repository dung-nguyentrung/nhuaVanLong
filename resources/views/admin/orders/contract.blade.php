    ...
    <main class="main cart">
        ...
        <div class="page-content">
            <div class="container mb-5">
                ...
                <p>
                    Hôm nay, ngày {{ date('d') }} tháng {{ date('m') }} năm {{ date('Y') }} , Tại Hải Phòng
                </p>
                <p>
                    Chúng tôi gồm có:
                </p>
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <p>
                            Tên doanh nghiệp: <i>Công ty TNHH nhựa Vân Long</i>
                        </p>
                        <p>
                            Mã số doanh nghiệp: <i>0201736858</i>
                        </p>
                        <p>
                            Địa chỉ trụ sở chính: <i>Số 15a, Dầu Lửa, Hùng Vương, Hồng Bàng, HP</i>
                        </p>
                        <p>
                            Điện thoại: {{ $setting->phone }} Fax: <i>{{ $setting->fax }}</i>
                        </p>
                        <p>
                            Tài khoản số: <i>…………………………………………………………</i>
                        </p>
                    ...
                    <div class="col-lg-6">
                        ...
                        <p>
                            Tên doanh nghiệp: <i>{{ $order->company_name }}</i>
                        </p>
                        <p>
                            Người đại diện: <i>{{ $order->name }}</i>
                        </p>
                        <p>
                            Địa chỉ trụ sở chính: <i>…………………………………………………</i>
                        </p>
                        <p>
                            Điện thoại: {{ $order->phone }} Email: <i>{{ $order->email }}</i>
                        </p>
                        <p>
                            Tài khoản số: <i>…………………………………………………………</i>
                        </p>
