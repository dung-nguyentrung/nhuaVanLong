                    ...
                    <form action="{{ route('posts.update', ['post' => $post->id]) }}" enctype="multipart/form-data" method="POST" data-toggle="validator">
                        ...
                        <div class="row">    
                            ...
                            <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="name_{{ $item }}" value="{{ $post->$name }}" class="form-control" placeholder="Nhập tên bài viết {{ $item }}">                                                         
                            </div>                                 
                            @endforeach
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea name="short_description_{{ $item }}" class="form-control" rows="3">
                                    {{ $post->$short }}
                                </textarea>
                            </div>
                            @endforeach
