    ...
    <div class="container">
                    ...
                    <div class="product text-center">
                        <figure class="product-media">
                            ...
                            <div class="product-action-vertical">
                                <a href="demo2.html#" class="btn-product-icon btn-cart w-icon-cart"
                                    title="Add to cart"></a>
                                <a href="demo2.html#" class="btn-product-icon btn-wishlist w-icon-heart"
                                    title="Add to wishlist"></a>
                                <a href="demo2.html#" class="btn-product-icon btn-quickview w-icon-search"
                                    title="Quickview"></a>
                                <a href="demo2.html#" class="btn-product-icon btn-compare w-icon-compare"
        ...
        <div class="tab tab-with-title tab-nav-boxed appear-animate">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" href="demo2.html#tab-1">New Arrivals</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="demo2.html#tab-2">Best Seller</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="demo2.html#tab-3">Most Popular</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="demo2.html#tab-4">View All</a>
                </li>
            </ul>
        </div>
        <!-- End of Tab Title-->
        ...
        <div class="sale-banner banner br-sm appear-animate">
            <div class="banner-content">
                ...
                <div class="content-right">
                    ...
                    <a href="demo2.html#" class="btn btn-white btn-rounded">Shop Now
            ...
            <div class="swiper-wrapper row cols-xl-8 cols-lg-6 cols-md-4 cols-2">
                <div class="swiper-slide product-wrap">
                    <div class="product text-center product-absolute">
                        <figure class="product-media">
                            <a href="https://portotheme.com/html/wolmart/product-defaproduct-default.html">
