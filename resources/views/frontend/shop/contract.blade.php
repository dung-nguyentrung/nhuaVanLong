    ...
    <main class="main cart">
        ...
        <div class="page-content">
            <div class="container mb-5">
                ...
                <p>
                    Hôm nay, ngày {{ date('d') }} tháng {{ date('m') }} năm {{ date('Y') }} , Tại TP Hải Phòng
                </p>
                <p>
                    Chúng tôi gồm có:
                </p>
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <p>
                            Địa chỉ trụ sở chính: <i>15a, Dầu Lửa, Hùng Vương, Hồng Bàng, Hải Phòng</i>
                        </p>
                        <p>
                    ...
                    <div class="col-lg-6">
                        ...
                        <p>
                            Tên khách hàng: <i>{{ $order->name }}</i>
                        </p>
                        <p>
                            Địa chỉ trụ sở chính: <i>{{ $order->address }}</i>
                        </p>
                        <p>
                            Điện thoại: {{ $order->phone }} Fax: <i>…………………………………</i>
                        </p>
                        <p>
                            Tài khoản số: <i>…………………………………………………………</i>
                        </p>
                ...
                <table style="width: 100%;" class="container" border="1px">
                    ...
                    <tfoot>
                        <tr>
                            <th>Tổng tiền</th>
                            <th>{{ number_format($item->order->total) }} đồng</th>
                        </tr>
                    </tfoot>
                </table>
                <p>
